...
class KittiDataset(DatasetTemplate):
    ...
    def create_groundtruth_database(self, info_path=None, used_classes=None, split='train'):
        ...
        # print(database_save_path) #/home/disk0/wx/lyt/TED/data/kitti/gt_database
    ...
    @staticmethod
    def generate_prediction_dicts(batch_dict, pred_dicts, class_names=['car'], output_path=None):
        """
        Args:
            batch_dict:
            ...
            class_names:,'pedestrian','bicycle','motorcycle','tricycle','van','cargo','truck','bus','semi-trailing tractor','special vechicl','roadblock'
            output_path:
        Returns:
        """
        ...
        def generate_single_sample_dict(batch_index, box_dict):
            ...
            # )
            pred_boxes_img =pred_boxes_camera
    ...
    def __getitem__(self, index):
        ...
        sample_idx = info['point_cloud']['lidar_idx']
        # points=info['point_cloud']['points']
        # 获取item列表
        # get_item_list = self.dataset_cfg.get('GET_ITEM_LIST', ['points'])
        # lidar_file = os.path.join(self.root_split_path,'velodyne', (self.sample_id_list[index] + self.ext))
        ...
        # gt = self.create_groundtruth(self.sample_id_list[index])
        # gt = self.get_infos(self.sample_id_list[index])
        # gt=copy.deepcopy(self.sample_id_list[index])
        # gt = copy.deepcopy(self.kitti_infos[index])
        # print(sample_idx)
        # gt=copy.deepcopy(self.get_infos(sample_idx))
        ...
        # selected = common_utils.keep_arrays_by_name(input_dict['gt_names'], self.class_names)
        # input_dict['gt_names'] = input_dict['gt_names'][selected]
